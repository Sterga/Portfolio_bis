...
.pauseFor(1800)
.changeDelay(20)
.typeString('<strong><span class="accueil-nom">Radia AHMED-ALI</span></strong><br>')
.pauseFor(300)

    .typeString('<br><li fa fa-check><span style="color: #27ae60; margin:30px"> Développeuse Python, </span></li>')
.pauseFor(1000)

    .typeString('<br><li fa fa-check><span style="color: #EA39ff; margin:30px"> Data AI Engineer, </span></li>')
.pauseFor(1000)

    .typeString('<br><li fa fa-check><span style="color: #ff6910; margin:30px"> Datascientist</span></li>')
.start()
